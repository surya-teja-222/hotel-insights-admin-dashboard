		...
		<main className="p-4 bg-primaryBg">
			<div className="flex p-4 justify-between">
				<div>
					...
					<p>
						Here are various types of rooms in the hotel. Click add
				...
				<div className="bg-white rounded-md m-6 p-4 min-h-[400px] w-fit mx-auto px-60">
					...
					<form onSubmit={handleSubmit}>
						<table>
							<tr>
								<td>
									<label className="p-2 mr-6" htmlFor="name">
										Name:
									</label>
								</td>
								<td>
							...
							<tr>
								<td>
									<label className="p-2 mr-6" htmlFor="price">
										Price:
									</label>
								</td>
								<td>
							...
							<tr>
								<td>
									<label className="p-2 mr-6" htmlFor="count">
										Count:
									</label>
								</td>
								<td>
